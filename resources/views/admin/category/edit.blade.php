    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content col-lg-offset-3 col-lg-6 m-auto">
                <form class="form-group" action="{{route('category.update', $category->id )}}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text"
                                       value="{{ $category->name }}"
                                       name="name" class="form-control" id="title" placeholder="Category">
                            </div>
                            <div class="form-group">
                                <label for="tagSlug">Category Slug</label>
                                <input type="text"
                                       value="{{ $category->slug }}"
                                       name="slug" class="form-control" id="tagSlug" placeholder="CategorySlug">
                            </div>
                        </div>
                        <!-- /.card-body -->
                    </div>
